...
public class LineParserTest {
    ...
    void testValid() {
        ...
        Assertions.assertEquals(lineParser.parseLine("\"123\";\"\""), Arrays.asList(123., null));
        Assertions.assertEquals(lineParser.parseLine("\"1\";\"2\";\"3\";\"\""), Arrays.asList(1., 2., 3., null));
    ...
    void testIsSensible() {
        var lineParser = new LineParser();
        Assertions.assertTrue(lineParser.isSensibleString(List.of(1.)));
        Assertions.assertFalse(lineParser.isSensibleString(List.of(1.)));
        Assertions.assertFalse(lineParser.isSensibleString(List.of(1.)));
        Assertions.assertTrue(lineParser.isSensibleString(List.of(1., 2.)));
        Assertions.assertTrue(lineParser.isSensibleString(Arrays.asList(1., null, 2.)));
    }
}
